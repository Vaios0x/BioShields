...
/**
 * Verify BioShield Insurance contracts on Base Sepolia
...
async function main() {
  console.log('🔍 Verificando contratos en Base Sepolia...')
  
  // Load deployment info
  const deploymentInfo = JSON.parse(fs.readFileSync('base-deployment.json', 'utf8'))
  ...
  console.log('📄 Información de deployment guardada en: base-deployment.json')
}
