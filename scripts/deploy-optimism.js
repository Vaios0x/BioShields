...
/**
 * Deploy BioShield Insurance contracts to Optimism Sepolia
...
async function main() {
  console.log('🚀 Iniciando deployment en Optimism Sepolia...')
  ...
  const deploymentInfo = {
    ...
    explorer: optimismSepoliaConfig.explorerUrl,
  }
  ...
  console.log('📄 Deployment info saved to optimism-deployment.json')
  console.log('🔍 View on explorer:', optimismSepoliaConfig.explorerUrl)
